...
const Rewards = ({ navigation }: any) => {
	const [selectedRewardsRankIndex, setSelectedRewardsRankIndex] =
		useState(0);
	const [selectedRewardsRank, setSelectedRewardsRank] = useState({});
	const [isSelectedRewardsRank, setIsSelectedRewardsRank] = useState(false);
	...
	return (
		<>
			<SafeAreaView style={{ flex: 1, backgroundColor: colors.white }}>
				...
				>
					...
					>
						...
						<RewardProgress
							selectedRewardsRankIndex={selectedRewardsRankIndex}
							setSelectedRewardsRankIndex={
								setSelectedRewardsRankIndex
							}
							selectedRewardsRank={selectedRewardsRank}
							setSelectedRewardsRank={setSelectedRewardsRank}
							isSelectedRewardsRank={isSelectedRewardsRank}
							setIsSelectedRewardsRank={setIsSelectedRewardsRank}
						/>
						<View
							style={{
								width: '100%',
			...
			<RewardDetailModal
				modalVisible={isSelectedRewardsRank}
				selectedRewardsRank={selectedRewardsRank}
				setModalVisible={setIsSelectedRewardsRank}
			/>
		</>
	);
};
